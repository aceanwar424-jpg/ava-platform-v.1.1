...
// di OneLab, lalu tekan Enter. Berjalan memakai sesi Anda sehingga RLS terhormat
...
// ════════════════════════════════════════════════════════════════════════
(async () => {
  if (typeof sbPost !== 'function') { alert('Buka OneLab & login dulu, baru tempel skrip ini.'); return; }
