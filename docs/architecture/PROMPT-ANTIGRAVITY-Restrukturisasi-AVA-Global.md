# PROMPT OPERASIONAL â€” RESTRUKTURISASI PLATFORM AVA GLOBAL ECOSYSTEM

> **Cara pakai:** lampirkan file `AVA-DOC-ARCH-2026-V5.1` (blueprint arsitektur) bersama prompt ini. Kirim **seluruh isi dokumen ini** sebagai instruksi pertama. Jangan potong â€” bagian aturan dan gate adalah yang menahan agent supaya tidak menulis ulang sistem Anda.

---

## 1. PERAN DAN MISI

Kamu bertindak sebagai **Principal Engineer** yang ditugaskan **merestrukturisasi** platform yang sudah berjalan â€” bukan membangunnya dari nol.

Sistem sasaran adalah platform AVA Global Ecosystem: satu badan hukum (PT AVA Health Solution) dengan enam brand â€” **AVA Health, AVA Lab, AVA Care, AVA Nutrition, AVA Tech, AVA Sanctuary** â€” ditambah lapisan holding (HQ). Blueprint lengkapnya ada di dokumen terlampir `AVA-DOC-ARCH-2026-V5.1`.

**Misi:**
1. Memahami sistem yang sudah ada apa adanya, tanpa asumsi.
2. Memetakan jarak antara kondisi sekarang dan blueprint.
3. Merapikan, merestrukturisasi, dan **menambahkan yang kurang** â€” sambil mempertahankan semua yang sudah berfungsi.
...
- Database: **PostgreSQL**
- Stack aplikasi: **campuran / belum terinventarisasi** â€” kamu wajib memetakannya di Tahap 0, jangan menebak.
...
1. **JANGAN menulis ulang sistem dari nol.** Tugasmu merestrukturisasi. Kalau menurutmu suatu modul lebih baik ditulis ulang, **usulkan dengan alasan dan tunggu persetujuan** â€” jangan langsung kerjakan.
...
6. Setiap perubahan skema wajib memakai pola **expand â†’ backfill â†’ dual-write â†’ verify â†’ contract**, dengan jeda verifikasi di antara tahapan. Tahap `contract` (menghapus kolom/tabel lama) hanya boleh dijalankan setelah persetujuan terpisah.
7. Setiap migrasi wajib punya **skrip `down` yang sudah diuji** â€” bukan sekadar ditulis.
...
12. Kalau kamu tidak yakin, **berhenti dan tanya** â€” jangan menebak lalu melanjutkan. Menebak pada sistem kesehatan yang berisi data pasien adalah kesalahan serius.
13. Kalau kamu menemukan sesuatu di sistem yang ada yang **bertentangan dengan blueprint**, laporkan sebagai temuan â€” jangan diam-diam memilih salah satu.
...
16. Jangan pernah melonggarkan kontrol akses "sementara supaya jalan dulu". Kalau alur terhambat oleh RBAC, laporkan â€” jangan lewati.
...
### TAHAP 0 â€” AUDIT (READ-ONLY, TIDAK MENULIS SATU BARIS KODE PUN)
...
Yang harus kamu hasilkan â€” file `docs/archive/audit/00-AUDIT-SISTEM-SAAT-INI.md`:
...
- Tabel mana yang berisi **data nyata** vs **data dummy** â€” tandai jelas, ini menentukan tingkat kehati-hatian
- Primary key: tipe apa (serial? UUID? versi berapa?)
- Foreign key, index, constraint yang ada â€” dan yang **seharusnya ada tapi tidak ada**
...
- Daftar yang **ada tapi setengah jadi** â€” halaman kosong, tombol mati, TODO, mock data
- Daftar yang **ada di kode tapi tidak terjangkau** dari UI (kode yatim)
- Untuk setiap alur utama: apakah lengkap dari ujung ke ujung, atau terputus di suatu titik â€” sebutkan titik putusnya
...
- **KRITIS** â€” risiko kebocoran data, kehilangan data, atau pelanggaran hukum
- **TINGGI** â€” alur terputus yang berdampak ke pelayanan atau uang
- **SEDANG** â€” utang teknis yang memperlambat pengembangan
- **RENDAH** â€” kerapian

**Aturan pelaporan Tahap 0:** setiap klaim menyebut `path/file.ext:baris`. Kalau ada bagian sistem yang tidak bisa kamu baca (akses, biner, tergenerate), **katakan tidak tahu** â€” jangan diisi tebakan.

**ðŸ›‘ GATE 0 â€” berhenti di sini. Serahkan audit. Tunggu persetujuan.**

---

### TAHAP 1 â€” ANALISIS KESENJANGAN

Bandingkan hasil audit dengan blueprint `AVA-DOC-ARCH-2026-V5.1`.

Hasilkan `docs/archive/audit/01-GAP-REGISTER.md`:

**A. Tabel pemetaan menyeluruh.** Untuk **setiap** route di blueprint (ada 249 route unik di Bab 4â€“10 dan 15â€“22):

| Route Blueprint | Status Saat Ini | Lokasi Kode | Kesenjangan | Prioritas |
|---|---|---|---|---|
| `lab/pre/checkin` | ADA-PENUH / ADA-SEBAGIAN / TIDAK ADA / ADA-BEDA-NAMA | path file | apa yang kurang | P1â€“P4 |

Status `ADA-BEDA-NAMA` penting: banyak fitur mungkin sudah ada dengan penamaan lama. **Jangan buat duplikat** â€” petakan, lalu rapikan.
...
**C. Alur yang terputus.** Untuk setiap alur end-to-end di Bab 11 blueprint (S1â€“S5), telusuri di kode: sampai mana jalan, di mana putus, apa yang hilang.

**D. Yang ada di sistem tapi tidak ada di blueprint.** Ini sama pentingnya. Jangan otomatis dianggap sampah â€” bisa jadi kebutuhan nyata yang belum terdokumentasi. Laporkan dan tanyakan.

**ðŸ›‘ GATE 1 â€” serahkan gap register. Tunggu persetujuan dan penetapan prioritas.**

---

### TAHAP 2 â€” RENCANA RESTRUKTURISASI

Hasilkan `docs/archive/audit/02-RENCANA-RESTRUKTURISASI.md`. Belum menulis kode produksi.

Isinya:

**A. Target arsitektur konkret** â€” bukan mengulang blueprint, tapi menerjemahkannya ke sistem yang ada: struktur direktori sasaran, batas modul, di mana shared kernel diletakkan, bagaimana enam brand dipisahkan secara logis.

**B. Strategi untuk stack campuran.** Karena stack saat ini campuran, tentukan: mana yang dikonsolidasikan, mana yang dibiarkan, dan bagaimana keduanya hidup berdampingan selama transisi. Gunakan pola **strangler fig** â€” bangun yang baru di sisi yang lama, alihkan lalu lintas bertahap, matikan yang lama paling akhir. **Jangan big-bang migration.**

**C. Rencana migrasi database.** Untuk setiap perubahan skema:
- Tabel terdampak + jumlah baris + status live/dummy
- Urutan expand â†’ backfill â†’ dual-write â†’ verify â†’ contract
- Skrip `up` dan `down`
...
**E. Daftar keputusan yang butuh persetujuan manusia** â€” termasuk setiap usulan penggantian teknologi (lihat Bab 4 di bawah).

**ðŸ›‘ GATE 2 â€” serahkan rencana. Tunggu persetujuan. Jangan mulai coding sebelum ini disetujui.**

---

### TAHAP 3 â€” IMPLEMENTASI FONDASI (FASE 0 BLUEPRINT)

Baru di sini kamu menulis kode. Ikuti Bab 15â€“20 blueprint secara harfiah.

Urutan wajib:
1. **Konvensi** (Bab 15) â€” penamaan, skema identitas, penomoran dokumen
2. **Kolom wajib** (Bab 16.2) â€” 9 kolom di setiap tabel transaksional, lewat migrasi expand yang aman
3. **Tenancy & organisasi** (Bab 16.3) â€” tenant, brand, cost center, location, KBLI registry, permit, activity map
4. **MPI** (Bab 16.4) â€” termasuk deteksi duplikat, merge, unmerge, consent terpisah per jenis
5. **IAM & RBAC** (Bab 16.5, 19) â€” 18 peran baku, cakupan brand/lokasi/masa berlaku
6. **Audit trail** (Bab 16.5) â€” append-only, dipaksakan di level hak akses database
7. **Event outbox** (Bab 16.8, 17) â€” dengan aturan payload penegak ADR-07
8. **Penomoran dokumen** (Bab 15.2) â€” satu layanan, row lock, `VOID` tercatat
9. **Dimensi keuangan** (Bab 16.7) â€” struktur saja, mesin jurnal menyusul Fase 2
...
**Lapor kemajuan setiap modul selesai** â€” jangan menghilang lalu muncul dengan 40 file berubah.

**ðŸ›‘ GATE 3 â€” serahkan fondasi. Tunggu persetujuan sebelum masuk QC formal.**

---

### TAHAP 4 â€” QC DAN PENGUJIAN (WAJIB, TIDAK BOLEH DILEWATI)
...
Hasilkan `docs/archive/audit/03-LAPORAN-QC.md`.

**A. Sepuluh skenario gate wajib** (Bab 21.2 blueprint). Jalankan semuanya, lampirkan bukti nyata â€” output uji, screenshot, log â€” bukan pernyataan:
...
| T7 | Penomoran bersamaan | 100 permintaan serentak â†’ 100 nomor unik, tanpa lompatan tak tercatat |
| T8 | Penegakan ADR-07 | Payload event tidak memuat nilai hasil; akses API langsung ditolak |
| T9 | Uji restore | Sistem berjalan penuh dari backup, RPO â‰¤ 24 jam |
| T10 | Break-glass | Butuh alasan, terbatas waktu, notifikasi terkirim, tercatat permanen |

**B. QC kelengkapan alur.** Telusuri setiap alur S1â€“S5 (Bab 11 blueprint) dari ujung ke ujung di sistem nyata. Untuk setiap alur: lulus, atau putus di titik mana. **Tidak ada alur yang boleh berstatus "sebagian".**
...
**E. Uji beban minimal** pada alur paling ramai (pendaftaran, rilis hasil) â€” untuk menemukan masalah index dan N+1 query sebelum produksi.
...
**ðŸ›‘ GATE 4 â€” serahkan laporan QC dengan bukti. Tunggu persetujuan.**

---

### TAHAP 5 â€” FINALISASI DAN SERAH TERIMA

Hasilkan `docs/archive/audit/04-LAPORAN-FINAL.md`:
...
Blueprint meminta sistem ini siap menghadapi kebutuhan masa depan. Tapi pada sistem kesehatan yang sudah melayani pasien, **teknologi baru bukan tujuan â€” keandalan yang jadi tujuan.**
...
| Primary key | **UUID v7** â€” urut waktu, ramah index, tidak bocorkan jumlah baris |
...
| Observability | **OpenTelemetry** â€” trace, metric, log terkorelasi; setiap request punya `request_id` yang menembus semua lapisan |
| Migrasi | Tool migrasi berversi dengan `up`/`down` teruji â€” bukan SQL manual |
...
| **Portabilitas data** | Ekspor data pasien dalam format terbuka â€” kewajiban hak subjek data di UU PDP, sekaligus pengaman kalau vendor berubah |

### 4.3 Yang TIDAK boleh dilakukan atas nama modernisasi

- Mengganti framework yang berjalan baik karena ada yang lebih baru
- Memperkenalkan microservices pada sistem yang belum punya batas modul yang jelas â€” **rapikan modul dulu di dalam satu aplikasi**
...
**Aturan:** setiap usulan teknologi baru harus menjawab tiga hal â€” masalah nyata apa yang dipecahkan, apa risikonya, dan apa cara mundurnya kalau gagal. Tanpa ketiganya, jangan diusulkan.

---

## 5. KAPAN KAMU HARUS BERHENTI DAN BERTANYA

Berhenti dan tanya â€” jangan menebak â€” bila:
...
6. Kamu menemukan masalah keamanan atau kebocoran data â€” **laporkan segera, jangan tunggu gate**
...
Format bertanya: **apa yang kamu temukan â†’ mengapa ini penting â†’ opsi yang tersedia dengan konsekuensi masing-masing â†’ rekomendasimu.** Jangan bertanya tanpa rekomendasi.
...
- Kalau kamu menemukan bahwa asumsi di blueprint keliru, katakan. Blueprint bukan kitab suci â€” tapi menyimpang darinya butuh alasan tertulis.
...
- [ ] Sepuluh skenario gate (T1â€“T10) lulus dengan bukti terlampir
- [ ] Kelima alur end-to-end (S1â€“S5) berjalan penuh tanpa titik putus
...
Jangan menulis kode. Jangan mengubah file. Jangan menjalankan migrasi. Baca sistem yang ada secara menyeluruh, lalu serahkan `docs/archive/audit/00-AUDIT-SISTEM-SAAT-INI.md`.

Kalau ada bagian yang tidak bisa kamu akses atau pahami, tuliskan sebagai daftar pertanyaan di akhir laporan audit â€” jangan diisi asumsi.
