...
- [ ] Migrasi 0056 belum dieksekusi ke Supabase production karena ini perubahan RLS/schema eksternal yang wajib melalui checkpoint administrator; tanpa langkah ini login akun yang belum menerima claim tenant masih dapat tertahan pada verifikasi profil.
