    ...
    <div style="min-height:85vh; background:#020617; color:#F8FAFC; padding:24px; font-family:'Plus Jakarta Sans', sans-serif;">
      ...
      <div style="background:rgba(15,23,42,0.85); border:1px solid rgba(255,255,255,0.08); border-radius:16px; padding:20px; backdrop-filter:blur(12px); display:flex; align-items:center; justify-content:space-between; margin-bottom:20px; flex-wrap:wrap; gap:14px;">
        <div style="display:flex; align-items:center; gap:16px;">
          <div style="width:50px; height:50px; border-radius:14px; background:linear-gradient(135deg, #10B981, #0EA5E9); display:flex; align-items:center; justify-content:center; color:white; font-size:24px; font-weight:800; shadow:0 10px 25px rgba(16,185,129,0.3);">
            🩺
          </div>
          <div>
            ...
            <p style="margin:4px 0 0 0; font-size:12px; color:#94A3B8;">Orkestrator Telekonsultasi · Pemantauan Wearable IoT · Badge Kalibrasi Alkes · Marketplace & Caregiver Network</p>
          </div>
        </div>
        ...
        <div style="background:rgba(15,23,42,0.8); border:1px solid rgba(255,255,255,0.08); border-radius:14px; padding:16px;">
          ...
          <div style="display:flex; flex-direction:column; gap:10px;">
            <div style="background:rgba(30,41,59,0.6); border:1px solid rgba(255,255,255,0.06); border-radius:10px; padding:12px;">
              ...
              <p style="font-size:11.5px; color:#94A3B8; margin:4px 0 8px 0;">Keluhan: Hasil tes HbA1c 8.2%, pusing & lemas harian.</p>
        ...
        <div style="background:rgba(15,23,42,0.8); border:1px solid rgba(255,255,255,0.08); border-radius:14px; padding:16px;">
          ...
          <div style="display:flex; flex-direction:column; gap:10px;">
            <div style="background:rgba(30,41,59,0.6); border:1px solid rgba(255,255,255,0.06); border-radius:10px; padding:12px;">
              ...
              <p style="font-size:11.5px; color:#94A3B8; margin:4px 0 8px 0;">Telemetri Tensimeter IoT: 155/95 mmHg (Hipertensi Gr 1)</p>
      ...
      <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap:16px;">
        ...
        <div style="background:rgba(15,23,42,0.8); border:1px solid rgba(239,68,68,0.4); border-radius:14px; padding:16px;">
          ...
          <div style="margin:14px 0; font-size:24px; font-weight:800; color:#FCA5A5;">
            165/102 <span style="font-size:12px; color:#94A3B8; font-weight:400;">mmHg</span>
          </div>
...
function switchAVAPortalView(portalRole) {
  ...
  if (portalRole === 'customer') {
    ...
    viewEl.innerHTML = `
      <div style="color:#38BDF8; font-weight:800; font-size:15px; margin-bottom:12px;">🩺 Portal Kerja Dokter Telehealth</div>
      <p style="font-size:12.5px; color:#94A3B8;">Konsol khusus dokter untuk menerima antrian pasien online, meninjau grafik telemetri alat rumah, menerbitkan e-resep, & cek saldo fee.</p>
      <div style="display:flex; gap:10px; margin-top:14px; flex-wrap:wrap;">
        <button class="btn btn-teal btn-sm" onclick="avaStartConsultModal()">💬 Sesi Konsultasi Baru</button>
    ...
    viewEl.innerHTML = `
      ...
      <p style="font-size:12.5px; color:#94A3B8;">Dashboard mitra untuk mengunggah katalog alkes, mendaftarkan nomor sertifikat kalibrasi, & mengklaim badge AVA Verified.</p>
      <div style="display:flex; gap:10px; margin-top:14px; flex-wrap:wrap;">
  ...
  modal.innerHTML = `
    <div style="background:#0F172A; border:1px solid rgba(52,211,153,0.4); border-radius:16px; padding:24px; width:100%; max-width:520px; color:#F8FAFC; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
      ...
      <div style="display:flex; flex-direction:column; gap:14px; font-size:13px;">
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Nama Pasien *</label>
          <input type="text" id="ac-patient" placeholder="Contoh: Bpk. Bambang S." style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        </div>
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Dokter Spesialis Tujuan *</label>
          <select id="ac-doctor" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        ...
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Keluhan Utama *</label>
          <textarea id="ac-complaint" rows="3" placeholder="Tuliskan keluhan atau gejala yang dirasakan..." style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none; resize:none;"></textarea>
        </div>
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Tingkat Triase AI (Edukatif)</label>
          <select id="ac-triage" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
...
function avaAddEPrescriptionModal(sessionId = 'SESI-101') {
  ...
  modal.innerHTML = `
    <div style="background:#0F172A; border:1px solid rgba(56,189,248,0.4); border-radius:16px; padding:24px; width:100%; max-width:500px; color:#F8FAFC; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
      ...
      <div style="display:flex; flex-direction:column; gap:14px; font-size:13px;">
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Rincian Obat & Dosis *</label>
          <textarea id="ep-drugs" rows="3" placeholder="Contoh: Metformin 500mg (2x1 sesudah makan), Captopril 25mg (1x1 pagi)" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none; resize:none;"></textarea>
        </div>
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Catatan Penggunaan Dokter</label>
          <input type="text" id="ep-notes" placeholder="Diminum teratur selama 30 hari" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        </div>
      </div>
      <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:22px; border-top:1px solid rgba(255,255,255,0.1); padding-top:14px;">
        <button class="btn btn-ghost btn-sm" onclick="document.getElementById('${modalId}').remove()">Batal</button>
...
function avaAddLabReferralModal(sessionId = 'SESI-101') {
  ...
  modal.innerHTML = `
    <div style="background:#0F172A; border:1px solid rgba(245,158,11,0.4); border-radius:16px; padding:24px; width:100%; max-width:500px; color:#F8FAFC; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
      ...
      <div style="display:flex; flex-direction:column; gap:14px; font-size:13px;">
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Pilih Jenis Tes Laboratorium *</label>
          <select id="lr-test" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        ...
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Diagnosa Kerja / Pengantar Dokter</label>
          <input type="text" id="lr-notes" placeholder="Evaluasi kontrol glikemik pasien rutin" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        </div>
      </div>
      <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:22px; border-top:1px solid rgba(255,255,255,0.1); padding-top:14px;">
        <button class="btn btn-ghost btn-sm" onclick="document.getElementById('${modalId}').remove()">Batal</button>
        <button class="btn btn-teal btn-sm" onclick="document.getElementById('${modalId}').remove(); toast('✅ Surat Rujukan Lab terbit & tersambung ke LIS OneLab!','ok');">Terbitkan Rujukan Lab</button>
      </div>
    </div>
  `;
  document.body.appendChild(modal);
...
function avaAddDeviceModal() {
  ...
  modal.innerHTML = `
    <div style="background:#0F172A; border:1px solid rgba(56,189,248,0.4); border-radius:16px; padding:24px; width:100%; max-width:500px; color:#F8FAFC; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
      ...
      <div style="display:flex; flex-direction:column; gap:14px; font-size:13px;">
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Nama Perangkat *</label>
          <input type="text" id="dev-name" placeholder="Contoh: Smartwatch Health-Pro X" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        </div>
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Tipe Telemetri *</label>
          <select id="dev-type" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
...
function avaAddCalibrationModal() {
  ...
  modal.innerHTML = `
    <div style="background:#0F172A; border:1px solid rgba(245,158,11,0.4); border-radius:16px; padding:24px; width:100%; max-width:500px; color:#F8FAFC; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
      ...
      <div style="display:flex; flex-direction:column; gap:14px; font-size:13px;">
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Nama Alat Medis *</label>
          <input type="text" id="cal-dev" placeholder="Contoh: Centrifuge Pro-5000" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        </div>
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">Nama Lab Kalibrasi Terakreditasi *</label>
          <input type="text" id="cal-lab" placeholder="Contoh: Balai Kalibrasi Kemenkes RI" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none;">
        </div>
        <div>
          <label style="display:block; margin-bottom:4px; font-weight:700; color:#94A3B8;">No. Sertifikat Kalibrasi *</label>
          <input type="text" id="cal-cert" placeholder="KAL-2026-XXXX" style="width:100%; padding:10px; background:rgba(30,41,59,0.8); border:1px solid rgba(255,255,255,0.1); border-radius:8px; color:#fff; outline:none; font-family:monospace;">
        </div>
      </div>
      <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:22px; border-top:1px solid rgba(255,255,255,0.1); padding-top:14px;">
        <button class="btn btn-ghost btn-sm" onclick="document.getElementById('${modalId}').remove()">Batal</button>
