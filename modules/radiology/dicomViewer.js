    ...
    <div style="background:#090D16; border:1px solid rgba(255,255,255,0.1); border-radius:12px; padding:16px; font-family:'Plus Jakarta Sans', sans-serif;">
      ...
      <div style="display:flex; align-items:center; justify-content:space-between; border-b:1px solid rgba(255,255,255,0.08); padding-bottom:10px; margin-bottom:12px;">
        <div style="display:flex; align-items:center; gap:8px;">
          ...
          <span style="font-size:13px; font-weight:700; color:#F8FAFC;">OHIF DICOM Medical Viewer</span>
        ...
        <div style="font-size:11px; font-family:monospace; color:#94A3B8;">
          Modality: <strong style="color:#F1F5F9;">CR/RONTGEN CHEST</strong>
        </div>
      </div>
      ...
      <div style="position:relative; width:100%; height:320px; background:#000; border-radius:8px; display:flex; align-items:center; justify-content:center; overflow:hidden; border:1px solid rgba(255,255,255,0.15);">
        <div style="text-align:center; color:#64748B; font-family:monospace;">
          ...
          <p style="margin:0; font-size:12px; color:#94A3B8;">[DICOM CANVASES LOADED: CHEST AP/LATERAL]</p>
          <p style="margin:4px 0 0 0; font-size:10px; color:#34D399;">AI Detection: No Pneumothorax Detected. Infiltration Minimal.</p>
        </div>

        {/* DICOM Overlay Stats */}
        <div style="position:absolute; top:10px; left:10px; font-size:10px; font-family:monospace; color:#38BDF8; background:rgba(0,0,0,0.6); padding:4px 8px; border-radius:4px;">
      ...
      <div style="display:flex; items-center; justify-content:space-between; margin-top:12px; font-size:11px;">
        <div style="display:flex; gap:6px;">
          <button style="background:rgba(255,255,255,0.08); color:white; border:none; padding:4px 10px; border-radius:6px; font-size:11px; cursor:pointer;">
            Zoom / Pan
          </button>
          <button style="background:rgba(255,255,255,0.08); color:white; border:none; padding:4px 10px; border-radius:6px; font-size:11px; cursor:pointer;">
            Window / Level
        ...
        <button onclick="alert('[AI PACS Overlay] Analisis AI Radiologi: Paru-paru & Jantung tampak normal (CTR < 50%).')" style="background:#0EA5E9; color:white; border:none; padding:4px 12px; border-radius:6px; font-weight:700; font-size:11px; cursor:pointer;">
