  ...
  "kategori": {
    ...
    "his": {
      ...
      "grup": [
        ...
        {
          "nama": "Penunjang Non-Lab",
          "menu": [
            {
              "id": "radiology",
              "label": "Radiologi & RIS",
              "status": "ada",
              "ket": "Order, worklist, dan hasil bacaan radiologi"
            },
            {
              "id": "pacs-viewer",
              "label": "PACS & DICOM Viewer",
              "status": "parsial",
              "ket": "Viewer siap; sumber citra DICOM belum tersambung"
            },
            {
              "id": "supportive",
              "label": "Penunjang Diagnostik (EKG, Audiometri, Spirometri)",
              "status": "ada",
              "ket": "Pemeriksaan penunjang non-lab: EKG 12 lead, treadmill, audiometri, faal paru"
            },
            {
              "id": "farmasi",
      ...
      "grup": [
        ...
        },
        {
          ...
          "menu": [
            ...
            },
            {
              ...
              "status": "ada",
              "ket": "Susunan panel dan paket MCU"
            },
            {
              "id": "refrange",
              "label": "Nilai Rujukan",
            ...
            {
              "id": "labreport",
              "label": "Format Hasil PDF Lab",
              "status": "ada",
              "rute": "labreport",
              "aksi": "navigate('settings',{tab:'pdf'})",
              "admin": true,
              "ket": "Kop surat, tanda tangan, dan tata letak lembar hasil"
            },
            {
              "id": "test-reviewer",
              "label": "Peninjau Deskripsi Tes",
              "status": "ada",
              "admin": true,
              "ket": "Penyuntingan massal deskripsi 530+ tes ke bahasa awam"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "menu": [
            {
              "id": "inventory",
              "label": "Stok Reagen & BHP",
              "status": "ada",
              "ket": "Saldo stok per gudang dan unit"
            },
            {
              "id": "inventory-recipe",
              "label": "Resep BHP per Pemeriksaan",
              "status": "ada",
              "ket": "Pemotongan stok otomatis per tes",
              "rute": "inventory",
              "aksi": "navigate('inventory',{tab:'recipe'})"
            },
            {
              "id": "inventory-po",
              "label": "Pesanan Pembelian Reagen",
              "status": "ada",
