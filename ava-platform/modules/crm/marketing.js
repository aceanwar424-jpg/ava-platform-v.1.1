...
const MKT_TYPES = [
  ...
  { key:'proposal',    label:'Proposal Mitra', icon:'',
    ...
    contentPlaceholder:'Dengan hormat,\n\nKami dari AVA Health & Lab Diagnostics...',
    hasFile: true,
...
// Bentuk Kerjasama — sesuai struktur template Surat Penawaran AVA
...
async function openMktForm(id=null, defaultType=null) {
  ...
  openModal(`
    ...
    <div class="form-group" id="mf-subject-group" style="display:${currentType==='email'?'flex':'none'};flex-direction:column;gap:5px">
      ...
      <input type="text" id="mf-subject" value="${t.subject||''}" placeholder="Penawaran Kerjasama AVA Health & Lab Diagnostics">
    </div>
