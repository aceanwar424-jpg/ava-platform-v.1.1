      ...
      <div class="card" style="border-left:4px solid ${c.primary_color||'var(--teal)'}">
        ...
        <div style="background:${c.bg_color||'#0A2342'};border-radius:10px;padding:14px;margin-bottom:12px;color:var(--on-accent);position:relative;overflow:hidden">
          ...
          <div style="position:relative;z-index:1">
            <div style="font-size:10px;opacity:.7;margin-bottom:4px">AVA Health & Lab Diagnostics</div>
...
Berikut voucher skrining kesehatan Anda dari *AVA Health & Lab Diagnostics* 
  ...
  openModal(`
    ...
    ">
      ...
      <div style="position:relative;z-index:1;display:flex;justify-content:space-between;align-items:flex-start">
        <div style="flex:1">
          <div style="font-size:11px;opacity:.6;font-weight:600;letter-spacing:.08em;margin-bottom:4px">AVA DIAGNOSTICS</div>
...
function printVoucher(id){
  ...
  w.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8">
    ...
    <div class="content">
      <div class="left">
        <div class="org">AVA DIAGNOSTICS</div>
