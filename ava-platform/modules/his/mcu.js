...
const MCU_STAGES = {
  ...
  S05:{ id:'S05', no:5,  phase:'F1', name:'Technical Meeting & Site Survey',      pic:'Sales + SPV',   icon:'', form:'F-TM-B2B',
    fields:['hari_tanggal_survey','waktu_pelaksanaan_tm','alamat_lokasi_onsite','pic_klien_tm','tim_survei_ava',
  ...
  const forms = {
      ...
      <div class="form-row">
        ...
        <div class="form-group"><label>Jenis Parameter Pemeriksaan</label>
          <select id="sf_jenis_parameter" ${ro}>
            ${['Paket Standar (Lampirkan)','Custom sesuai Risiko Pekerjaan','Rekomendasi Tim Medis AVA'].map(s=>`<option${val('jenis_parameter')===s?' selected':''}>${s}</option>`).join('')}
          </select>
        </div>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group"><label>Penanganan Limbah B3</label>
          <select id="sf_limbah_b3" ${ro}>
            ${['Dibawa Tim AVA','Manifes Lokal Klien'].map(s=>`<option${val('limbah_b3')===s?' selected':''}>${s}</option>`).join('')}
          </select>
        </div>
      </div>
    ...
    S05: ()=>`
      ...
      <div class="form-row">
        ...
        <div class="form-group"><label>Tim Survei AVA (Nama &amp; Jabatan)</label><input type="text" id="sf_tim_survei_ava" value="${val('tim_survei_ava')}" ${ro}></div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group"><label>Konektivitas Internet</label>
          <select id="sf_konektivitas_internet_tm" ${ro}>
            ${['Wi-Fi Klien (Whitelist IP LIS sudah diajukan)','Modem Router Portable Tim AVA'].map(s=>`<option${val('konektivitas_internet_tm')===s?' selected':''}>${s}</option>`).join('')}
          </select>
        </div>
      ...
      <table style="width:100%;font-size:11px;border-collapse:collapse;margin-bottom:10px">
        ...
        <tbody>
          ${[
            ...
            ['dok3','F-05-B2B (Order MCU — copy signed)'],['dok4','Database Peserta (Excel format AVA, sudah dicleansing)'],
    ...
    S15: ()=>`
      ...
      <div class="form-row">
        <div class="form-group"><label>SPV Project (AVA)</label><input type="text" id="sf_spv_project_s15" value="${val('spv_project_s15')||project.pic_spv||''}" ${ro}></div>
