  ...
  el.innerHTML = Object.entries(byDay).map(([d,items])=>`
    <div style="margin-bottom:18px">
      ...
      ${items.map(a=>{
        ...
        const wa = a.patient_phone ? `https://wa.me/${a.patient_phone.replace(/\D/g,'').replace(/^0/,'62')}?text=${encodeURIComponent(`Halo ${a.patient_name}, mengingatkan perjanjian Anda di AVA Health & Lab Diagnostics pada ${formatDateShort(d)} pukul ${t} untuk layanan ${a.service_type||''}. Terima kasih.`)}` : '';
