...
async function renderHRD() {
  document.getElementById('main-content').innerHTML = `
    <div class="page-header">
      <div><h1>HRD &amp; SDM</h1>
        <p>Data karyawan, absensi, cuti, dan penggajian AVA Health & Lab Diagnostics</p></div>
      <div class="btn-row">
...
async function openEmpForm(id=null) {
  ...
  openModal(`
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        <label>Email</label>
        <input type="email" id="ef-email" value="${e.email||''}" placeholder="nama@ava.id">
      </div>
      <div class="form-group">
...
function openCreateAccountForm(empId, empName, empEmail) {
  openModal(`
    ...
    <div class="form-group">
      ...
      <input type="email" id="ca-email" value="${empEmail||''}" placeholder="nama@ava.id">
